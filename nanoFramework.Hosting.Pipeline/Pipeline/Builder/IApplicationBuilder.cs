...

{
    ...
    public interface IApplicationBuilder
    {
        ...
        /// <exception cref="InvalidOperationException">"No service for type <paramref name="serviceType"/> has been registered.</exception>
        /// <exception cref="InvalidOperationException">"Unable to resolve service for type <paramref name="serviceType"/> must be a subclass of Middleware to activate.</exception>
        ...
        /// </summary>
        /// <param name="serviceType">An object that specifies the type of service object to get.</param>
        /// <param name="parameters">An array of arguments that match in number, order, and type the parameters of the constructor to invoke. 
        ...
        /// <exception cref="InvalidOperationException">"No service for type <paramref name="serviceType"/> has been registered.</exception>
        /// <exception cref="InvalidOperationException">"Unable to resolve service for type <paramref name="serviceType"/> must be a subclass of Middleware to activate.</exception>
        IApplicationBuilder Use(Type serviceType, params object[] parameters);
