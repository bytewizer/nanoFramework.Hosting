...
{
    /// <summary>
    /// Represents an options method to configure <see cref="ApplicationBuilder"/> specific features.
    /// </summary>
    /// <param name="configure">The <see cref="SocketServerService"/> configuration specific features.</param>
    public delegate void ApplicationBuilderAction(IApplicationBuilder configure);
}